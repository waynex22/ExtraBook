...
const Sidebar = () => {
    return (
        <div className='min-h-[800px] min-w-[150px] max-w-[220px] top-0 right-0 flex px-4 mt-2 mb-8 ml-5'>
            <div className='bg-white w-64 p-4 shadow-lg rounded-md'>
                <Link  to='/' className='text-2xl font-bold mb-8 text-center'>
                    <img
                        src="https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/774ba0fd-c421-4cba-9f2b-56b562cc850c/dad334l-85a94053-c912-42ee-b8b8-dce283ccf278.png/v1/fill/w_1600,h_900/byviruzz_xtra_watermark_by_flopperdesigns_dad334l-fullview.png?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..h9EofU2LHb6WborFfv269nJvC2wnjEMHXpCgRHqeugk"
                        className='h-20 mr-3'
                        alt='Zics Store Logo'
                    />
                </Link>
                <ul className="menu bg-base-200 rounded-box px-1">
                    <li className='py-8 my-4'>
                        <Link to='/admin'>
                            <div className='flex items-center justify-between'>
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                                </svg>
                                <h1 className="font-extrabold text-transparent text-md bg-clip-text bg-gradient-to-r from-red-400 to-blue-400">
                                    Trang Chính
                                </h1>
                            </div>
                        </Link>
