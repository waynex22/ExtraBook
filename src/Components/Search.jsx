    ...
    <div className="flex flex-col relative flex-start items-center">
      <form>
        ...
        <div className="relative">
          ...
          >
            {searchQuery && (
              <svg onClick={() => setSearchQuery('')} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 text-red-600 h-6">
